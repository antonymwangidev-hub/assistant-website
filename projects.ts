...
export const projects: Project[] = [
  ...
  {
    id: "ai-resume-academic-writer",
    title: "AI-Powered Resume & Cover Letter Generator with Smart Academic Writing Assistant (ETHICAL)",
    category: "AI Projects",
    description: "Comprehensive AI writing tool that generates personalized resumes and cover letters while providing ethical academic writing assistance with proper citations and plagiarism prevention.",
    image: "https://images.unsplash.com/photo-1456324504439-367cee3b3c32?w=600&h=400&fit=crop",
    tags: ["AI Writing", "Resume Builder", "Academic Writing", "Ethical AI", "NLP"],
  ...
  },
  {
    ...
    category: "Design",
    description: "Diverse collection of graphic design projects including logos, posters, branding, and digital illustrations showcasing creative problem-solving and visual communication skills.",
    image: "https://images.unsplash.com/photo-1626785774625-0b1c9c5b2c1a?w=600&h=400&fit=crop",
    tags: ["Graphic Design", "Branding", "Illustrations", "Adobe Creative Suite"],
    liveUrl: "https://design-portfolio.com",
  },
  {
    id: "sales-automation",
